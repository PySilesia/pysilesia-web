...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/home/ext/.buildout/eggs/distribute-0.6.30-py2.7.egg'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        '/home/ext/.buildout/eggs/distribute-0.6.30-py2.7.egg',
        '/home/ext/.buildout/eggs/zc.buildout-1.6.3-py2.7.egg'
        ]
    ...
    original_paths = [
        ...
        '/usr/local/lib/python2.7/dist-packages/NINJA_IDE-2.1.1-py2.7.egg',
        '/usr/local/lib/python2.7/dist-packages',
